...
?>
  <div class="contentBody">
    ...
    <div class="col-md-12 mainTitle"><strong><?php echo $CLICSHOPPING_New_Template->getDef('text_new_template') ; ?></strong></div>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="form-group">
            <div class="col-md-12">
              <?php echo $CLICSHOPPING_New_Template->getDef('text_intro');  ?>
            </div>
          </div>
          <div class="separator"></div>
          ...
          <div class="col-md-12 text-md-center">
            <div class="form-group">
              <div class="col-md-12">
<?php
  echo HTML::form('configure', CLICSHOPPING::link(null, 'A&Catalog\New_Template&Configure'));
  echo HTML::button($CLICSHOPPING_New_Template->getDef('button_configure'), null, null, 'primary');
  echo '</form>';
?>
              </div>
            </div>
